...
/*   Updated: 2019/10/04 22:55:39 by cyuriko          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

static void		init_params_ship(t_graphon *graf, t_fract *frac)
{
...
void			draw_ship(t_graphon *graphon, t_fract *fractol, t_window *win)
{
	init_params_ship(graphon, fractol);
	run_ship(graphon, win);
}
