...
/*   Updated: 2019/10/04 15:27:27 by cyuriko          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	zoom_in(int x, int y, t_fractol *fractol)
{
	...
	k_re = (double)x * (fractol->max_re - fractol->min_re) / (double)MAP_W + fractol->min_re;
	k_im = (double)y * (fractol->max_im - fractol->min_im) / (double)MAP_H + fractol->min_im;
